 ...
 */
@Component({
  selector: 'ds-print-certificate',
  styleUrls: ['./sedici-print-certificate.scss'],
  templateUrl: './sedici-print-certificate.html',
...
export class PrintableCertificate implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    if (itemRD?.hasSucceeded && itemRD.payload) {
      this.itemDso = itemRD.payload;
      }
    });
    this.itemIdentifiers = setPersistentIdentifiers(this.itemDso, this.identifierOtherMetadataName);
  }
